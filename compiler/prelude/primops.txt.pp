...
primop ReadTRefIntOp "readTRefInt#" GenPrimOp
    RefU# s Int# -> State# s -> (# State# s, Int# #)
   {Read contents of {\tt RefU\#}.}
   with
   out_of_line = True
   has_side_effects = True

primop WriteTRefIntOp "writeTRefInt#" GenPrimOp
    RefU# s Int# -> Int# -> State# s -> State# s
   {Write contents of {\tt RefU\#}.  Result is not yet evaluated.}
   with
   out_of_line = True
   has_side_effects = True
